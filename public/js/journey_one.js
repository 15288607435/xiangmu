...
//分页对象
function Page(){
    this.config = {elemId:'#page',pageIndex:'1',total:'0',pageSize:'3'};//默认参数
    ...
    this.pageHtml = function(){
        ...
        var pageSize = isBlank(data.pageSize) ? 3 : parseInt(data.pageSize);//可显示页码个数
        ...
        if(pageIndex <= 0 || pageIndex == 1){
            pageHtml += '<li class="disabled"><a href="javascript:;" data-pageindex="'+ pageIndex +'">首页</a></li>' +
                '<li><a href="http://127.0.0.1:3000/journey2.html" data-pageindex="'+ (pageIndex - 1) +'">下一页</a></li>'+'<li><a href="http://127.0.0.1:3000/journey3.html" data-pageindex="'+ (pageIndex - 1) +'">末页</a></li>';
        }else{
            pageHtml += '<li><a href="javascript:;" data-pageindex="1">首页</a></li>' +
                '<li><a href="http://127.0.0.1:3000/journey1.html" data-pageindex="'+ (pageIndex - 1) +'">上一页</a></li>';
                
        }

        // if(pageTotal == 1 ||  pageTotal <= pageIndex){
        //      pageHtml += '<li class="disabled"><a href="http://127.0.0.1:3000/journey1.html" data-pageindex="'+ pageTotal +'">首页</a></li>' +
        //          '<li class="disabled"><a href="http://127.0.0.1:3000/journey3.html" data-pageindex="'+ pageTotal +'">下一页</a></li>'+'<li class="disabled"><a href="http://127.0.0.1:3000/journey3.html" data-pageindex="'+ pageTotal +'">末页</a></li>';
        //  }else{
        //      pageHtml += '<li><a href="javascript:;" data-pageindex="'+ (pageIndex + 1) +'">下一页</a></li>' +
        //          '<li><a href="http://127.0.0.1:3000/journey3.html" data-pageindex="'+ pageTotal +'">末页</a></li>';
        // }
        pageHtml += '</ul>'
        $(elemId).html('');
